...
```shell
conda create -n trainer-env python=3.11.15
...
Create a clean Python environment with Python 3.10.20 or 3.11.15 and activate it before you start, if you haven't done so already:
```shell
conda create -n trainer-env python=3.11.15
conda activate trainer-env
```
